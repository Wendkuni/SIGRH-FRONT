  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadComponent: () => import('./space/Agent_Space/affectation/agent-affectation-permutation/agent-affectation-permutation.component').then(item => item.AgentAffectationPermutationComponent)
      },
