...
@Component({
  selector: 'mrt-agent-demande-titularisation',
  standalone: true,
  imports: [
    ToastModule,
    ConfirmDialogModule,
  ...
  templateUrl: './agent-demande-titularisation.component.html',
  styleUrl: './agent-demande-titularisation.component.scss',
  providers: [MessageService, ConfirmationService],
})
export class AgentDemandeTitularisationComponent {
