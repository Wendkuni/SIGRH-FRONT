...
@Component({
  selector: 'mrt-agent-position-detachemnt',
  standalone: true,
  imports: [
    ToastModule,
    ConfirmDialogModule,
  ...
  templateUrl: './agent-position-detachemnt.component.html',
  styleUrl: './agent-position-detachemnt.component.scss',
  providers: [MessageService, ConfirmationService],
})
export class AgentPositionDetachemntComponent {
