...
@Component({
  selector: 'mrt-agent-retraite-anticiper',
  standalone: true,
  imports: [
    ToastModule,
    ConfirmDialogModule,
  ...
  templateUrl: './agent-retraite-anticiper.component.html',
  styleUrl: './agent-retraite-anticiper.component.scss',
  providers: [MessageService, ConfirmationService],
})
export class AgentRetraiteAnticiperComponent {
