...
@Component({
  selector: 'mrt-agent-certificat-prise-service',
  standalone: true,
  imports: [
    ToastModule,
    ConfirmDialogModule,
  ...
  templateUrl: './agent-certificat-prise-service.component.html',
  styleUrl: './agent-certificat-prise-service.component.scss',
  providers: [MessageService, ConfirmationService],
})
export class AgentCertificatPriseServiceComponent {
