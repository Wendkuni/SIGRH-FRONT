...
@Component({
  selector: 'mrt-permutation-niveau-departemental',
  standalone: true,
  imports: [
    ButtonModule,
    RippleModule,
  ...
  templateUrl: './permutation-niveau-departemental.component.html',
  styleUrl: './permutation-niveau-departemental.component.scss',
  providers: [MessageService,ConfirmationService]
})
export class PermutationNiveauDepartementalComponent {
