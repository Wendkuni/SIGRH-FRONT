...
@Component({
  selector: 'mrt-allocation-familiale-non-traiter',
  standalone: true,
  imports: [
    ButtonModule,
    CalendarModule,
  ...
  templateUrl: './allocation-familiale-non-traiter.component.html',
  styleUrl: './allocation-familiale-non-traiter.component.scss'
})
export class AllocationFamilialeNonTraiterComponent {
