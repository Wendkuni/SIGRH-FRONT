...
@Component({
  selector: 'mrt-allocation-familiale-traiter',
  standalone: true,
  imports: [
    ButtonModule,
    CalendarModule,
  ...
  templateUrl: './allocation-familiale-traiter.component.html',
  styleUrl: './allocation-familiale-traiter.component.scss'
})
export class AllocationFamilialeTraiterComponent implements OnInit {
